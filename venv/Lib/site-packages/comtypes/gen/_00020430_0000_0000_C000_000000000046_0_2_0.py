...
IFontDisp = Font
__all__ = [ 'OLE_XPOS_PIXELS', 'Gray', 'OLE_XSIZE_PIXELS',
           'Monochrome', 'IFont', 'OLE_XPOS_HIMETRIC',
           'FONTUNDERSCORE', 'IFontDisp', 'OLE_HANDLE', 'Color',
           'OLE_ENABLEDEFAULTBOOL', 'OLE_YPOS_PIXELS',
           'OLE_YSIZE_CONTAINER', 'OLE_XSIZE_HIMETRIC', 'StdFont',
           'OLE_YPOS_CONTAINER', 'IPicture', 'FONTSTRIKETHROUGH',
           'VgaColor', 'OLE_OPTEXCLUSIVE', 'LoadPictureConstants',
           'IPictureDisp', 'FONTITALIC', 'OLE_XSIZE_CONTAINER',
           'Default', 'OLE_TRISTATE', 'FontEvents', 'FONTSIZE',
           'Checked', 'FONTNAME', 'StdPicture', 'Picture',
           'IFontEventsDisp', 'Font', 'FONTBOLD',
           'OLE_XPOS_CONTAINER', 'OLE_COLOR', 'Unchecked',
